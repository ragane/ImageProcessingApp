...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.ImageProcessingBox.setGeometry(QtCore.QRect(700, 10, 581, 591))
        ...
        self.BgrButton.clicked.connect(self.ImgDispLabel.clear) # type: ignore
        self.RgbButton.clicked.connect(self.ImgDispLabel.clear) # type: ignore
        self.HsvButton.clicked.connect(self.ImgDispLabel.clear) # type: ignore
        self.GrayButton.clicked.connect(self.ImgDispLabel.clear) # type: ignore
        # High-pass filtering buttons
        self.SobelButton.clicked.connect(self.ImgDispLabel.clear) # type: ignore
